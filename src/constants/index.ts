...
export const PERSONAL_DETAILS: PersonalItem[] = [
  {
    name: "Lakshya Mahawar",
    ...
    email: "lakshyamahawar14@gmail.com",
    phone: "+91 6350643154",
...
export const SOCIAL_LINKS: SocialLinkItem[] = [
  {
    icon: "Github",
    name: "GitHub",
    link: "https://github.com/lakshyamahawar14",
  },
  {
    icon: "Linkedin",
    name: "LinkedIn",
    link: "https://www.linkedin.com/in/lakshya-mahawar-099788209/",
  },
];
...
export const EDUCATION: EducationItem[] = [
  ...
  },
  {
    ...
    subtitle: "D S Science Academy, Gangapur City (RBSE)",
    score: "96.4%",
  },
];
...
export const SKILLS: SkillCategoryItem[] = [
  ...
  {
    title: "Emerging Tech & Enterprise (SAP)",
    skills: [
      "Generative AI",
...
export const PROJECTS: ProjectItem[] = [
  {
    ...
    skills: ["NodeJS", "NextJS", "TailwindCSS", "Stockfish 18 Lite", "Zustand"],
  ...
  },
  {
    ...
    skills: ["Python", "NLTK", "NLP", "Clustering", "Sentiment Analysis"],
  },
];