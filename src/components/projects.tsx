      ...
      <div className="w-full flex flex-col gap-12 lg:gap-20">
        {PROJECTS.map((project: ProjectItem, index: number) =>
          project.imageSrc ? (
            <div
              key={index}
              className="scroll-section w-full min-h-[100dvh] flex items-center justify-center py-12 lg:py-16 px-4 sm:px-6 lg:px-12 xl:px-16"
            >
              <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-10 lg:gap-12 xl:gap-16">
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-5 text-left">
                  <div className="flex flex-col sm:flex-row lg:flex-col justify-between items-start gap-2">
            ...
            <div
              key={index}
              className="scroll-section w-full max-w-5xl mx-auto px-4 py-8 lg:px-16 flex flex-col gap-5 text-left"
            >
